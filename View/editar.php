    ...
    echo "<table border='1'>";
        ...
        echo "<tbody>";
            echo "<tr>";
                ...
                echo "<td>";
                    echo "<input type='text' name='id_animal' value='{$registro['nombre']}'>";
                echo "</td>";
                echo "<td>";
                    echo "<input type='text' name='id_animal' value='{$registro['especie']}'>";
                echo "</td>";
                echo "<td>";
                    echo "<input type='text' name='id_animal' value='{$registro['tipo']}'>";
                echo "</td>";
                echo "<td>";
                    echo "<input type='text' name='id_animal' value='{$registro['peso']}'>";
                echo "</td>";
                echo "<td>";
                    echo "<input type='text' name='id_animal' value='{$registro['edad']}'>";
                echo "</td>";
                echo "<td>";
                    echo "<input type='text' name='id_animal' value='{$registro['dieta']}'>";
                echo "</td>";
                echo "<td>";
                    echo "<input type='text' name='id_animal' value='{$registro['observacion']}'>";
                echo "</td>";
                echo "<td>";
